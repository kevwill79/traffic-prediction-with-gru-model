...
from extract_fdot_historical_data import extract_traffic_data, get_historical_traffic

# Extract historical data from fdot (Florida Dept of Transportation) site
pdf_path = "C:/Users/kwill/Desktop/grad_classes/Master_Project_cpsc_69100/fdot_historical_traffic_data/3_57_CAADT.pdf"

def process_data(data_path):
    # Load and preprocess data
    #df = extract_traffic_data(data_path)
    df = get_historical_traffic(data_path)
